...
export const Header = () => {
  ...
  const [darkMode, setDarkode] = useState(JSON.parse(localStorage.getItem("darkMode")) || false)
  ...
  const activeClass = "text-base block py-2 px-3 text-white bg-blue-700  md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500"
  ...
  return (
    <header>
       <nav className="bg-white border-b-2 border-gray-200 sm:px-4 py-2 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900">
